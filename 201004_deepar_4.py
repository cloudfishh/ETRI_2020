...
# input으로 test point 이전 일주일 (24*6 + 23), output으로 test point 1 point

# training set으로 이전 2주로 일단.
# training set으로 이전 한달

# 1. input 1일, training 2주 (O)
# 2. input 1일, training 4주
# 3. input 1주, training 2주
# 4. input 1주, training 4주
...
pd.DataFrame(sample_list).to_csv(f'200928_deepar-result_input{len_input}_train{len_train}.csv')
