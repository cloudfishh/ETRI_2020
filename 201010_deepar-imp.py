...
for idx in idx_cand:
    ...
    pd.DataFrame(forecast_fwd[0].samples.transpose()).to_csv(f'/home/ubuntu/Documents/sypark/2020_ETRI/csv_temp/201010_deepar_{idx}_fwd.csv')
    pd.DataFrame(forecast_bwd[0].samples.transpose()[::-1]).to_csv(f'/home/ubuntu/Documents/sypark/2020_ETRI/csv_temp/201010_deepar_{idx}_bwd.csv')
